...
/// Screen 3B: School subjects configuration with add, rename, remove, reorder,
/// and duplicate detection.
class SchoolSubjectsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SchoolSubjectsScreen> createState() => _SchoolSubjectsScreenState();
}

class _SchoolSubjectsScreenState extends ConsumerState<SchoolSubjectsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final notifier = ref.read(onboardingProvider.notifier);
    final schoolData = onboarding.schoolData;
    final gradeTitle = schoolData?.grade ?? 'School Classes';
    final subjects = schoolData?.subjects ?? [];
    ...
    return OnboardingScaffold(
      ...
      child: Column(
        ...
        children: [
          ...
          AppSpacing.v8,
          Text(
            'Organizing classes for $gradeTitle. You can rename, reorder, or add custom subjects.',
            textAlign: TextAlign.center,
          ...
          if (subjects.isEmpty)
            Padding(
              ...
              child: AppEmptyState(
                ...
                description: 'Add your first school subject to organize your class materials.',
            ...
            ReorderableListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Container(
                  key: ValueKey('school_subject_${index}_$subject'),
